...
- **Professional Rules**: Members of the Colegio de Abogados de Bolivia must comply with applicable professional conduct rules (reglamento de ética profesional) when using AI tools
...
1. Checking the official source (Gaceta Oficial de Bolivia — gacetaoficialdebolivia.gob.bo)
...
This Tool aggregates data from official Bolivian legal databases. However:

| Source Type | Authority Level | Use Case |
|------------|----------------|----------|
| **Gaceta Oficial de Bolivia (gacetaoficialdebolivia.gob.bo)** | Authoritative | Statute text, decrees, regulations (primary reference) |
| **Tribunal Constitucional Plurinacional** | Authoritative | Constitutional jurisprudence |
...
- LexisBol, InfoLeg Bolivia, or institutional legal repositories maintained by Bolivian universities (UMSA, UMSS)

These services provide editorial oversight and professional-grade currency guarantees that this Tool **cannot** provide.
...
- Bolivian law changes continuously through new statutes (leyes), supreme decrees (decretos supremos), ministerial resolutions (resoluciones ministeriales), and court decisions (fallos)
...
- Even "fresh" data may be outdated if recent amendments were published in the Gaceta Oficial
- Staleness warnings do not guarantee completeness or accuracy
- Always check official sources for the current legal position (estado normativo actual)

### Amendments and Repeals

- A provision marked "in force" may have been:
  - Amended (modificado) after the last database update
  - Repealed (abrogado) but not yet removed from the database
...
1. **Complete case law** -- Coverage of Tribunal Constitucional Plurinacional, Tribunal Supremo de Justicia, and lower court decisions is limited; do not rely solely on this for jurisprudence research (investigación jurisprudencial)
2. **Historical statute versions** -- Limited availability of historical provision wording (texto histórico)
3. **Legal commentary** -- No editorial annotations (anotaciones), academic commentary (doctrina), or practice guides
4. **Unpublished decisions** -- Lower court decisions and administrative rulings (resoluciones administrativas) largely absent
5. **Full legislative history** -- Limited coverage of parliamentary materials (informes de comisión, exposición de motivos)
6. **Departmental regulations** -- Regulatory instruments at the departmental level may be missing
...
- **International Law Blind Spots**: Cannot fully assess obligations under international treaties or MERCOSUR-associated frameworks
...
- This includes but is not limited to:
  - Professional malpractice claims (responsabilidad por mala praxis)
...
- Provide competent representation (diligencia profesional)

## Recommended Workflow for Professional Use

1. **Initial Research**: Use Tool for preliminary research and hypothesis generation
2. **Official Verification**: Cross-check ALL results with official sources (gacetaoficialdebolivia.gob.bo)
...
This disclaimer may be updated as the Tool evolves or legal/regulatory requirements change. Check the [GitHub repository](https://github.com/Ansvar-Systems/bolivian-law-mcp) for the current version.

## Questions?

For questions about this disclaimer or the Tool's limitations, please open an issue on GitHub:
https://github.com/Ansvar-Systems/bolivian-law-mcp/issues
...
- **ALWAYS VERIFY** all legal information with official sources (Gaceta Oficial de Bolivia — gacetaoficialdebolivia.gob.bo)
...
- **COMPLY** with Colegio de Abogados de Bolivia professional ethics rules regarding AI tool use and client confidentiality
